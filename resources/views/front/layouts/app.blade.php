            ...
            <div class="col-12">
                ...
                <div class="offcanvas_menu_wrapper">
                    ...
                    <div class="welcome-text">
                        <p>{{ __('website.welcome_message') }}</p>
                    </div>
                    <div class="language_currency text-center">
                        <ul>
                            <li class="language"><a href="#">{{ __('website.language') }}<i
                    ...
                    <div id="menu" class="text-left">
                        <ul class="offcanvas_main_menu">
                            <li class="menu-item-has-children"><a
                                    href="{{route('home')}}">{{ __('website.home') }}</a></li>
                            <li class="menu-item-has-children"><a
                                    href="{{route('about')}}">{{ __('website.about') }}</a></li>
                            <li class="menu-item-has-children">
                                <a href="{{route('products')}}">{{ __('website.our_products') }}</a>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{route('products')}}"
                                           class="{{$segment=='products'||$segment=='product' ? 'active' : ''}}">{{ __('website.our_products') }}</a>
                                        @if(isset($categories) && $categories!=null)
                                            <ul class="sub_menu">
                                                @foreach($categories as $category)
                                                    <li>
                                    ...
                                    <li><a href="{{route('contact_us')}}"
                                           class="{{$segment=='contact_us' ? 'active' : ''}}">{{ __('website.contact_us') }}</a>
                                    </li>
    ...
    <div class="footer_top">
        <div class="container">
            <div class="row">
                    ...
                    <div class="widgets_container widget_menu">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="{{route('products')}}">{{ __('website.our_products') }}</a></li>
                                <li>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="widgets_container widget_menu">
                        <h3>{{ __('website.main_categories') }}</h3>
                        <div class="footer_menu">
                            @if(isset($categories) && $categories!=null)
                                <ul>
                                    @foreach($categories as $category)
                                ...
                                <div class="variants_selects">
                                    <div class="modal_add_to_cart">
                                        <a class="modal_button"
                                           id="product_url">{{ __('website.view_full_details') }}</a>
                                    </div>
                                </div>
                                <div class="modal_social">
                                    <h2>{{ __('website.share_product') }}</h2>
                                    <ul>
...
<script type="text/javascript">
    ...
    (function () {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/692b1cbeb154901962a52dea/1jb86gi7i';
        s1.charset = 'UTF-8';
