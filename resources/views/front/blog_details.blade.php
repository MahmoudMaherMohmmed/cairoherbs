            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <h3>{{ __('website.blog_details') }}</h3>
                        <ul>
                            <li><a href="{{route('home')}}">{{ __('website.home') }}</a></li>
                            <li>{{ __('website.blog_details') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <article class="single_blog">
                            <figure>
                                <div class="post_header">
                                    <h3 class="post_title">{{getDefaultValueKey($blog->title)}}</h3>
                                    <div class="blog_meta">
                                ...
                                <figcaption class="blog_content">
                                    <div class="post_content">
                                        <p>{!! getDefaultValueKey($blog->description) !!}</p>
                                    </div>
                                    <div class="entry_content">
                                        <div class="social_sharing">
                                            <p>{{ __('website.share_this_post') }}</p>
                                            <ul>
