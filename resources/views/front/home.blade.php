                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section_title">
                            <h2>{{ __('website.featured_products') }}</h2>
                        </div>
                    </div>
                </div>
        ...
        <section class="blog_section blog_s_three">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section_title">
                            <h2>{{ __('website.our_latest_posts') }}</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <figure>
                                        ...
                                        <figcaption class="blog_content">
                                            <h4 class="post_title"><a
                                                    href="{{route('blog_details',[$blog->slug])}}">{{getDefaultValueKey($blog->title)}}</a>
                                            </h4>
                                            <div class="articles_date">
                                                <p>By <span>admin / {{$blog->created_at->format('M d, Y')}}</span></p>
                                            </div>
                                            <p class="post_desc">
                                                {{ \Illuminate\Support\Str::words( strip_tags(getDefaultValueKey($blog->description)), $words = 20, $end = '...') }}
                                            </p>
                                            <footer class="blog_footer">
                                                <a href="{{route('blog_details',[$blog->slug])}}">{{ __('website.continue_reading') }}</a>
                                            </footer>
                                        </figcaption>
                                    </figure>
                                </article>
